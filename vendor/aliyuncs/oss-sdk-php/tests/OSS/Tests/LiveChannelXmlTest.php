<?php
 namespace OSS\Tests; require_once __DIR__ . '/Common.php'; use OSS\Model\LiveChannelInfo; use OSS\Model\LiveChannelListInfo; use OSS\Model\LiveChannelConfig; use OSS\Model\GetLiveChannelStatus; use OSS\Model\GetLiveChannelHistory; class LiveChannelXmlTest extends \PHPUnit_Framework_TestCase { private $config = <<<BBBB
