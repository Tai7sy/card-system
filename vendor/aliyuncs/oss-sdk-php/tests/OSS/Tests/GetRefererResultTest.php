<?php
 namespace OSS\Tests; use OSS\Result\GetRefererResult; use OSS\Http\ResponseCore; use OSS\Core\OssException; class GetRefererResultTest extends \PHPUnit_Framework_TestCase { private $validXml = <<<BBBB
