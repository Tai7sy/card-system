<?php
 namespace OSS\Tests; use OSS\Core\OssException; use OSS\Result\InitiateMultipartUploadResult; use OSS\Http\ResponseCore; class InitiateMultipartUploadResultTest extends \PHPUnit_Framework_TestCase { private $validXml = <<<BBBB
