...
CHANGE COLUMN `email_sent` `send_status`  tinyint(4) NOT NULL DEFAULT 0 AFTER `contact`;
            '); Schema::table('orders', function (Blueprint $sp8280da) { $sp8280da->text('contact_ext')->nullable()->after('contact'); }); } } public function down() { } }