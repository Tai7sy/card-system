...
<head>
    ...
    <link type="text/css" href="/plugins/css/jd_qr.css" rel="stylesheet">
...
<div class="body">
    <h1 class="mod-title">
        <span class="ico-wechat"></span><span class="text">京东支付</span>
    </h1>
    <div class="mod-ct">
        <div class="order"></div>
        ...
        <div id="open-app-container">
            <span style="display: block;margin-top: 24px">请截屏此界面或保存二维码，打开京东APP扫码，选择相册图片</span>
        </div>
